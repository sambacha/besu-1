...
public class IbftLegacyBesuControllerBuilder extends BesuControllerBuilder {
  ...
  createSubProtocolConfiguration(final EthProtocolManager ethProtocolManager) {
    return new SubProtocolConfiguration().withSubProtocol(
        Istanbul64Protocol.get(), ethProtocolManager);
  }
  ...
  createConsensusContext(final Blockchain blockchain,
    ...
    return new IbftContext(voteTallyCache, voteProposer, epochManager,
                           blockInterface);
  }
  ...
  protected EthProtocolManager createEthProtocolManager(
    ...
    return new Istanbul64ProtocolManager(
        ...
        peerValidators, fastSyncEnabled, scheduler);
  }
}
