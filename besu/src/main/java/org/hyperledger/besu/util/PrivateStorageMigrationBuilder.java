...
public class PrivateStorageMigrationBuilder {
  ...
  public PrivateStorageMigrationBuilder(final BesuController besuController,
  ...
  public PrivateStorageMigration build() {
    ...
    final LegacyPrivateStateStorage legacyPrivateStateStorage =
        privacyParameters.getPrivateStorageProvider()
            .createLegacyPrivateStateStorage();
    final PrivateStateRootResolver privateStateRootResolver =
        privacyParameters.getPrivateStateRootResolver();

    return new PrivateStorageMigration(
        blockchain, privacyPrecompileAddress, protocolSchedule,
        publicWorldStateArchive, privateStateStorage, privateStateRootResolver,
        legacyPrivateStateStorage, PrivateMigrationBlockProcessor::new);
  }
}
