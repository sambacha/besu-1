...
public class NoRewardProtocolScheduleWrapper implements ProtocolSchedule {
  ...
  public ProtocolSpec getByBlockNumber(final long number) {
    ...
    final BlockValidator noRewardBlockValidator = new MainnetBlockValidator(
        original.getBlockHeaderValidator(), original.getBlockBodyValidator(),
        noRewardBlockProcessor);
    final BlockImporter noRewardBlockImporter =
