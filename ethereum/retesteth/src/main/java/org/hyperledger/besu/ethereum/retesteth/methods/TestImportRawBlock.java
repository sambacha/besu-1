...
public class TestImportRawBlock implements JsonRpcMethod {
  ...
  public JsonRpcResponse response(final JsonRpcRequestContext requestContext) {
    ...
    final ProtocolSpec protocolSpec =
        context.getProtocolSpec(context.getBlockHeight());
    final ProtocolContext protocolContext = this.context.getProtocolContext();

    final Block block;
    try {
      block = Block.readFrom(RLP.input(Bytes.fromHexString(input)),
    ...
    if (blockImporter.importBlock(protocolContext, block,
