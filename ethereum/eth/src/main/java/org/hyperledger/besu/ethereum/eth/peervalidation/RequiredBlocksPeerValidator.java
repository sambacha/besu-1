...
public class RequiredBlocksPeerValidator extends AbstractPeerBlockValidator {
  ...
  RequiredBlocksPeerValidator(final ProtocolSchedule protocolSchedule,
                              final MetricsSystem metricsSystem,
                              final long blockNumber, final Hash hash,
                              final long chainHeightEstimationBuffer) {
    super(protocolSchedule, metricsSystem, blockNumber,
          chainHeightEstimationBuffer);
    this.hash = hash;
  }

  public RequiredBlocksPeerValidator(final ProtocolSchedule protocolSchedule,
                                     final MetricsSystem metricsSystem,
                                     final long blockNumber, final Hash hash) {
    this(protocolSchedule, metricsSystem, blockNumber, hash,
