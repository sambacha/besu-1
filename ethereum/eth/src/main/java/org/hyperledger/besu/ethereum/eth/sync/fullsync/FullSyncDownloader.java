...
public class FullSyncDownloader {
  ...
  public FullSyncDownloader(final SynchronizerConfiguration syncConfig,
    ...
    this.chainDownloader = FullSyncChainDownloader.create(
  ...
  public void stop() { chainDownloader.cancel(); }
