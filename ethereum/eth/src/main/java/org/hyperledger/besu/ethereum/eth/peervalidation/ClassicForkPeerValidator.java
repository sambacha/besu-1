...
public class ClassicForkPeerValidator extends AbstractPeerBlockValidator {
  ...
  ClassicForkPeerValidator(final ProtocolSchedule protocolSchedule,
  ...
  public ClassicForkPeerValidator(final ProtocolSchedule protocolSchedule,
                                  final MetricsSystem metricsSystem,
                                  final long daoBlockNumber) {
  ...
  boolean validateBlockHeader(final EthPeer ethPeer, final BlockHeader header) {
    ...
    if (!validClassicBlock) {
      LOG.info("Peer {} is invalid because Classic block ({}) is invalid.",
               ethPeer, blockNumber);
    }
