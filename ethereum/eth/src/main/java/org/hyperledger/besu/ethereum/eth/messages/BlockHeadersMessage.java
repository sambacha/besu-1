...
public final class BlockHeadersMessage extends AbstractMessageData {
  ...
  public static BlockHeadersMessage readFrom(final MessageData message) {
    ...
    if (code != EthPV62.BLOCK_HEADERS) {
      throw new IllegalArgumentException(String.format(
          "Message has code %d and thus is not a BlockHeadersMessage.", code));
    }
  ...
  public static BlockHeadersMessage
  create(final Iterable<BlockHeader> headers) {
  ...
  private BlockHeadersMessage(final Bytes data) { super(data); }
