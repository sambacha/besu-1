...
public class RetryingGetHeaderFromPeerByNumberTask
  ...
  private RetryingGetHeaderFromPeerByNumberTask(
      ...
      final MetricsSystem metricsSystem, final long pivotBlockNumber,
  ...
  public static RetryingGetHeaderFromPeerByNumberTask
  forSingleNumber(final ProtocolSchedule protocolSchedule,
                  final EthContext ethContext,
                  final MetricsSystem metricsSystem,
                  final long pivotBlockNumber, final int maxRetries) {
    return new RetryingGetHeaderFromPeerByNumberTask(
        protocolSchedule, ethContext, metricsSystem, pivotBlockNumber,
        maxRetries);
  }
  ...
  executePeerTask(final Optional<EthPeer> assignedPeer) {
    ...
    return executeSubTask(getHeadersTask::run).thenApply(peerResult -> {
