...
public abstract class AbstractMinerExecutor<
  ...
  public AbstractMinerExecutor(final ProtocolContext protocolContext,
  ...
  startAsyncMining(final Subscribers<MinedBlockObserver> observers,
    ...
    try {
      final M currentRunningMiner =
          createMiner(observers, ethHashObservers, parentHeader);
  ...
  public abstract M
  createMiner(final Subscribers<MinedBlockObserver> subscribers,
              final Subscribers<EthHashObserver> ethHashObservers,
              final BlockHeader parentHeader);
