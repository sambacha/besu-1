...
public class PrivJsonRpcMethodsTest {
  ...
  @Before
  public void setup() {
    privJsonRpcMethods = new PrivJsonRpcMethods(
  ...
  @Test
  public void
  offchainPrivacyGroupMethodsAreDisabledWhenOnchainPrivacyGroupIsEnabled() {
    ...
    assertThat(rpcMethods.get(PRIV_CREATE_PRIVACY_GROUP.getMethodName()))
        .isNull();
    assertThat(rpcMethods.get(PRIV_DELETE_PRIVACY_GROUP.getMethodName()))
        .isNull();
    assertThat(rpcMethods.get(PRIV_FIND_PRIVACY_GROUP.getMethodName()))
        .isNull();
  }

  @Test
  public void
  offchainPrivacyGroupMethodsAreEnabledWhenOnchainPrivacyGroupIsDisabled() {
