...
public class PrivJsonRpcMethods extends PrivacyApiGroupJsonRpcMethods {
  ...
  public PrivJsonRpcMethods(final BlockchainQueries blockchainQueries,
  ...
  create(final PrivacyController privacyController,
    ...
    if (getPrivacyParameters().isOnchainPrivacyGroupsEnabled()) {
      return mapOf(new PrivGetTransactionReceipt(
                       getBlockchainQueries(), getPrivacyParameters(),
                   ...
                   new PrivGetPrivateTransaction(
                       getBlockchainQueries(), privacyController,
                   ...
                   new PrivCall(getBlockchainQueries(), privacyController,
                                enclavePublicKeyProvider),
                   new PrivGetCode(getBlockchainQueries(), privacyController,
                                   enclavePublicKeyProvider),
                   new PrivGetLogs(getBlockchainQueries(), getPrivacyQueries(),
                                   privacyController, enclavePublicKeyProvider),
                   new PrivNewFilter(filterManager, privacyController,
                                     enclavePublicKeyProvider),
                   new PrivUninstallFilter(filterManager, privacyController,
                                           enclavePublicKeyProvider),
                   new PrivGetFilterLogs(filterManager, privacyController,
                                         enclavePublicKeyProvider),
                   new PrivGetFilterChanges(filterManager, privacyController,
                                            enclavePublicKeyProvider));
    } else {
      return mapOf(
