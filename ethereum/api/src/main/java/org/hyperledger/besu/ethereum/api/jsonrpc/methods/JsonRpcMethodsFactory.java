...
public class JsonRpcMethodsFactory {
  ...
  public Map<String, JsonRpcMethod> methods(
      final String clientVersion, final BigInteger networkId,
      final GenesisConfigOptions genesisConfigOptions,
      final P2PNetwork p2pNetwork, final BlockchainQueries blockchainQueries,
      final Synchronizer synchronizer, final ProtocolSchedule protocolSchedule,
      final FilterManager filterManager, final TransactionPool transactionPool,
    ...
    if (!rpcApis.isEmpty()) {
      ...
      final List<JsonRpcMethods> availableApiGroups = List.of(
          new AdminJsonRpcMethods(clientVersion, networkId,
                                  genesisConfigOptions, p2pNetwork,
                                  blockchainQueries, namedPlugins, natService),
          new DebugJsonRpcMethods(blockchainQueries, protocolSchedule,
                                  metricsSystem),
          ...
          new EthJsonRpcMethods(
              ...
              transactionPool, miningCoordinator, supportedCapabilities),
          new NetJsonRpcMethods(p2pNetwork, protocolSchedule,
                                jsonRpcConfiguration, webSocketConfiguration,
                                metricsConfiguration),
          new MinerJsonRpcMethods(miningCoordinator),
          new PermJsonRpcMethods(accountsWhitelistController,
                                 nodeWhitelistController),
          new PrivJsonRpcMethods(blockchainQueries, protocolSchedule,
                                 transactionPool, privacyParameters,
                                 filterManager),
