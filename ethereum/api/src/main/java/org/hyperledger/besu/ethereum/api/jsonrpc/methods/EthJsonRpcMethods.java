...
public class EthJsonRpcMethods extends ApiGroupJsonRpcMethods {
  ...
  public EthJsonRpcMethods(final BlockchainQueries blockchainQueries,
  ...
  protected Map<String, JsonRpcMethod> create() {
    return mapOf(
        new EthAccounts(), new EthBlockNumber(blockchainQueries),
        ...
        new EthCall(
            blockchainQueries,
            new TransactionSimulator(blockchainQueries.getBlockchain(),
                                     blockchainQueries.getWorldStateArchive(),
                                     protocolSchedule)),
        new EthGetCode(blockchainQueries), new EthGetLogs(blockchainQueries),
        ...
        new EthGetTransactionByHash(blockchainQueries,
        ...
        new EthGetTransactionCount(blockchainQueries,
                                   transactionPool.getPendingTransactions()),
        new EthGetTransactionReceipt(blockchainQueries),
        new EthUninstallFilter(filterManager),
        new EthGetFilterChanges(filterManager),
        new EthGetFilterLogs(filterManager), new EthSyncing(synchronizer),
        new EthGetStorageAt(blockchainQueries),
        new EthSendRawTransaction(transactionPool), new EthSendTransaction(),
        new EthEstimateGas(
            blockchainQueries,
            new TransactionSimulator(blockchainQueries.getBlockchain(),
                                     blockchainQueries.getWorldStateArchive(),
                                     protocolSchedule)),
        new EthMining(miningCoordinator), new EthCoinbase(miningCoordinator),
        new EthProtocolVersion(supportedCapabilities),
        new EthGasPrice(miningCoordinator), new EthGetWork(miningCoordinator),
