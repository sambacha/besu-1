...
public class HandlerFactory {
  ...
  timeout(final TimeoutOptions globalOptions,
          final Map<String, JsonRpcMethod> methods, final boolean decodeJSON) {
    ...
    return HANDLERS.computeIfAbsent(
        ...
        -> TimeoutHandler.handler(
            ...
            methods.keySet().stream().collect(
                Collectors.toMap(String::new, ignored -> globalOptions)),
            decodeJSON));
  }
}
