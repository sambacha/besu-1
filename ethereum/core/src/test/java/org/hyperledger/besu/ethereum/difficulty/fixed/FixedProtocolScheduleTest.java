...
public class FixedProtocolScheduleTest {
  ...
  public void reportedDifficultyForAllBlocksIsAFixedValue() {
    ...
    final ProtocolSchedule schedule = FixedDifficultyProtocolSchedule.create(
    ...
    assertThat(
        schedule.getByBlockNumber(0).getDifficultyCalculator().nextDifficulty(
            1, parentHeader, null))
        .isEqualTo(FixedDifficultyCalculators.DEFAULT_DIFFICULTY);

    assertThat(
        schedule.getByBlockNumber(500).getDifficultyCalculator().nextDifficulty(
            1, parentHeader, null))
        .isEqualTo(FixedDifficultyCalculators.DEFAULT_DIFFICULTY);

    assertThat(schedule.getByBlockNumber(500_000)
