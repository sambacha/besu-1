...
public final class MainnetBlockHeaderValidator {
  ...
  public static final Bytes DAO_EXTRA_DATA =
      Bytes.fromHexString("0x64616f2d686172642d666f726b");
  ...
  public static final Bytes CLASSIC_FORK_BLOCK_HEADER = Bytes.fromHexString(
  ...
  public static BlockHeaderValidator.Builder createDaoValidator() {
    return createValidator().addRule(new ConstantFieldValidationRule<>(
  ...
  public static BlockHeaderValidator.Builder createClassicValidator() {
    return createValidator().addRule(new ConstantFieldValidationRule<>(
        "hash",
        h
        -> h.getNumber() == 1920000 ? h.getBlockHash()
  ...
  public static boolean validateHeaderForClassicFork(final BlockHeader header) {
    return header.getNumber() != 1_920_000 ||
        header.getHash().equals(CLASSIC_FORK_BLOCK_HEADER);
  }
  ...
  static BlockHeaderValidator.Builder createOmmerValidator() {
    return new BlockHeaderValidator.Builder()
        ...
        .addRule(new GasLimitRangeAndDeltaValidationRule(MIN_GAS_LIMIT,
                                                         MAX_GAS_LIMIT))
        .addRule(new GasUsageValidationRule())
        .addRule(
            new TimestampMoreRecentThanParent(MINIMUM_SECONDS_SINCE_PARENT))
        .addRule(new ExtraDataMaxLengthValidationRule(
            BlockHeader.MAX_EXTRA_DATA_BYTES))
  ...
  static BlockHeaderValidator.Builder
  createEip1559Validator(final EIP1559 eip1559) {
  ...
  static BlockHeaderValidator.Builder
  createEip1559OmmerValidator(final EIP1559 eip1559) {
    ExperimentalEIPs.eip1559MustBeEnabled();
    return new BlockHeaderValidator.Builder()
        .addRule(CalculatedDifficultyValidationRule::new)
        .addRule(new AncestryValidationRule())
