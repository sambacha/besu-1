...
public class CalculatedDifficultyValidationRule
    implements AttachedBlockHeaderValidationRule {
  private static final Logger LOG = LogManager.getLogger();
  private final DifficultyCalculator difficultyCalculator;

  public CalculatedDifficultyValidationRule(
  ...
  public boolean validate(final BlockHeader header, final BlockHeader parent,
    ...
    final BigInteger expectedDifficulty = difficultyCalculator.nextDifficulty(
        header.getTimestamp(), parent, context);
