...
public abstract class MainnetPrecompiledContractRegistries {
  ...
  private static void
  populateForFrontier(final PrecompileContractRegistry registry,
                      final GasCalculator gasCalculator,
                      final int accountVersion) {
    registry.put(Address.ECREC, accountVersion,
                 new ECRECPrecompiledContract(gasCalculator));
    registry.put(Address.SHA256, accountVersion,
                 new SHA256PrecompiledContract(gasCalculator));
    registry.put(Address.RIPEMD160, accountVersion,
                 new RIPEMD160PrecompiledContract(gasCalculator));
    registry.put(Address.ID, accountVersion,
                 new IDPrecompiledContract(gasCalculator));
  }
  ...
  private static void
  populateForByzantium(final PrecompileContractRegistry registry,
                       final GasCalculator gasCalculator,
                       final int accountVersion) {
    populateForFrontier(registry, gasCalculator, accountVersion);
    registry.put(
        Address.MODEXP, accountVersion,
        new BigIntegerModularExponentiationPrecompiledContract(gasCalculator));
    registry.put(Address.ALTBN128_ADD, accountVersion,
                 AltBN128AddPrecompiledContract.byzantium(gasCalculator));
    registry.put(Address.ALTBN128_MUL, accountVersion,
                 AltBN128MulPrecompiledContract.byzantium(gasCalculator));
    registry.put(Address.ALTBN128_PAIRING, accountVersion,
  ...
  private static void
  populateForIstanbul(final PrecompileContractRegistry registry,
                      final GasCalculator gasCalculator,
                      final int accountVersion) {
    populateForByzantium(registry, gasCalculator, accountVersion);
    registry.put(Address.ALTBN128_ADD, Account.DEFAULT_VERSION,
                 AltBN128AddPrecompiledContract.istanbul(gasCalculator));
    registry.put(Address.ALTBN128_MUL, Account.DEFAULT_VERSION,
                 AltBN128MulPrecompiledContract.istanbul(gasCalculator));
    registry.put(Address.ALTBN128_PAIRING, Account.DEFAULT_VERSION,
                 AltBN128PairingPrecompiledContract.istanbul(gasCalculator));
    registry.put(Address.BLAKE2B_F_COMPRESSION, Account.DEFAULT_VERSION,
  ...
  private static void
  populateForBerlin(final PrecompileContractRegistry registry,
                    final GasCalculator gasCalculator,
                    final int accountVersion) {
    populateForIstanbul(registry, gasCalculator, accountVersion);
    registry.put(Address.BLS12_G1ADD, Account.DEFAULT_VERSION,
                 new BLS12G1AddPrecompiledContract());
    registry.put(Address.BLS12_G1MUL, Account.DEFAULT_VERSION,
                 new BLS12G1MulPrecompiledContract());
    registry.put(Address.BLS12_G1MULTIEXP, Account.DEFAULT_VERSION,
                 new BLS12G1MultiExpPrecompiledContract());
    registry.put(Address.BLS12_G2ADD, Account.DEFAULT_VERSION,
                 new BLS12G2AddPrecompiledContract());
    registry.put(Address.BLS12_G2MUL, Account.DEFAULT_VERSION,
                 new BLS12G2MulPrecompiledContract());
    registry.put(Address.BLS12_G2MULTIEXP, Account.DEFAULT_VERSION,
                 new BLS12G2MultiExpPrecompiledContract());
    registry.put(Address.BLS12_PAIRING, Account.DEFAULT_VERSION,
                 new BLS12PairingPrecompiledContract());
    registry.put(Address.BLS12_MAP_FP_TO_G1, Account.DEFAULT_VERSION,
                 new BLS12MapFpToG1PrecompiledContract());
    registry.put(Address.BLS12_MAP_FP2_TO_G2, Account.DEFAULT_VERSION,
  ...
  public static PrecompileContractRegistry berlin(
    ...
    final PrecompileContractRegistry registry =
        new PrecompileContractRegistry();
    populateForBerlin(registry,
                      precompiledContractConfiguration.getGasCalculator(),
                      Account.DEFAULT_VERSION);
    return registry;
  }

  static void appendPrivacy(final PrecompileContractRegistry registry,
