...
public class MainnetBlockImporter implements BlockImporter {
  ...
  importBlock(final ProtocolContext context, final Block block,
    ...
    outputs.ifPresent(processingOutputs
                      -> context.getBlockchain().appendBlock(
                          block, processingOutputs.receipts));
  ...
  @Override
  public boolean
  fastImportBlock(final ProtocolContext context, final Block block,
                  final List<TransactionReceipt> receipts,
                  final HeaderValidationMode headerValidationMode,
                  final HeaderValidationMode ommerValidationMode) {

    if (blockValidator.fastBlockValidation(context, block, receipts,
