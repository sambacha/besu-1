...
public class NodeSmartContractPermissioningAcceptanceTest
  ...
  public void setUp() {
    ...
    permissionedCluster.start(bootnode, forbiddenNode, allowedNode,
                              permissionedNode);
  ...
  public void permissionedNodeShouldDisconnectFromNodeNotPermittedAnymore() {
    ...
    permissionedNode.verify(
        connectionIsForbidden(permissionedNode, allowedNode));
  ...
  public void permissionedNodeShouldConnectToNewlyPermittedNode() {
    ...
    permissionedNode.verify(
        connectionIsAllowed(permissionedNode, forbiddenNode));
