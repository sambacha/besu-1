...
public class BesuNodeFactory {
  ...
  private final GenesisConfigurationFactory genesis =
      new GenesisConfigurationFactory();
  private final NodeConfigurationFactory node = new NodeConfigurationFactory();

  public BesuNode create(final BesuNodeConfiguration config)
      throws IOException {
    return new BesuNode(
        config.getName(), config.getDataPath(), config.getMiningParameters(),
        config.getJsonRpcConfiguration(), config.getWebSocketConfiguration(),
        config.getMetricsConfiguration(),
        config.getPermissioningConfiguration(), config.getKeyFilePath(),
        config.isDevMode(), config.getGenesisConfigProvider(),
        config.isP2pEnabled(), config.getNetworkingConfiguration(),
        config.isDiscoveryEnabled(), config.isBootnodeEligible(),
        config.isRevertReasonEnabled(), config.isSecp256k1Native(),
        config.isAltbn128Native(), config.getPlugins(),
        config.getExtraCLIOptions(), config.getStaticNodes(),
        config.getPrivacyParameters(), config.getRunCommand());
  }

  public BesuNode createMinerNode(final String name) throws IOException {
    return create(new BesuNodeConfigurationBuilder()
                      .name(name)
                      .miningEnabled()
                      .jsonRpcEnabled()
                      .webSocketEnabled()
  ...
  public BesuNode createMinerNodeWithRevertReasonEnabled(final String name)
      throws IOException {
    return create(new BesuNodeConfigurationBuilder()
                      .name(name)
                      .miningEnabled()
  ...
  public BesuNode createNode(
      final String name,
      final Function<BesuNodeConfigurationBuilder, BesuNodeConfigurationBuilder>
          configModifier) throws IOException {
  ...
  public Node createArchiveNodeThatMustNotBeTheBootnode(final String name)
      throws IOException {
    return create(new BesuNodeConfigurationBuilder()
                      .name(name)
                      .jsonRpcEnabled()
  ...
  public BesuNode
  createArchiveNodeWithDiscoveryDisabledAndAdmin(final String name)
      throws IOException {
    return create(new BesuNodeConfigurationBuilder()
                      .name(name)
  ...
  public BesuNode createArchiveNodeNetServicesEnabled(final String name)
      throws IOException {
  ...
  public BesuNode createArchiveNodeNetServicesDisabled(final String name)
      throws IOException {
    return create(new BesuNodeConfigurationBuilder()
                      .name(name)
                      .jsonRpcConfiguration(node.jsonRpcConfigWithAdmin())
  ...
  public BesuNode
  createNodeWithAuthenticationUsingJwtPublicKey(final String name)
      throws IOException, URISyntaxException {
    return create(new BesuNodeConfigurationBuilder()
                      .name(name)
                      .jsonRpcEnabled()
  ...
  public BesuNode createNodeWithP2pDisabled(final String name)
      throws IOException {
    return create(new BesuNodeConfigurationBuilder()
                      .name(name)
                      .p2pEnabled(false)
  ...
  public BesuNode
  createNodeWithMultiTenantedPrivacy(final String name, final String enclaveUrl,
                                     final String authFile,
    ...
    final PrivacyParameters privacyParameters =
        privacyParametersBuilder.setMultiTenancyEnabled(true)
            .setEnabled(true)
            ...
            .setPrivateKeyPath(Paths.get(
                ClassLoader.getSystemResource(privTransactionSigningKey)
                    .toURI()))
            .build();
  ...
  public BesuNode createArchiveNodeWithRpcDisabled(final String name)
      throws IOException {
    return create(new BesuNodeConfigurationBuilder().name(name).build());
  }

  public BesuNode createPluginsNode(final String name,
  ...
  public BesuNode createArchiveNodeWithRpcApis(final String name,
                                               final RpcApi... enabledRpcApis)
      throws IOException {
    final JsonRpcConfiguration jsonRpcConfig =
        node.createJsonRpcEnabledConfig();
    jsonRpcConfig.setRpcApis(asList(enabledRpcApis));
    final WebSocketConfiguration webSocketConfig =
        node.createWebSocketEnabledConfig();
  ...
  public BesuNode createNodeWithNoDiscovery(final String name)
      throws IOException {
    return create(new BesuNodeConfigurationBuilder()
                      .name(name)
                      .discoveryEnabled(false)
  ...
  public BesuNode createIbft2NonValidatorBootnode(final String name,
    ...
    return create(
        new BesuNodeConfigurationBuilder()
            ...
            .jsonRpcConfiguration(
                node.createJsonRpcWithIbft2AdminEnabledConfig())
            .webSocketConfiguration(node.createWebSocketEnabledConfig())
            .devMode(false)
            .genesisConfigProvider(
                validators
                -> genesis.createIbft2GenesisConfigFilterBootnode(validators,
                                                                  genesisFile))
            .bootnodeEligible(true)
            .build());
  }

  public BesuNode createIbft2Node(final String name, final String genesisFile)
      throws IOException {
    return create(
        new BesuNodeConfigurationBuilder()
            .name(name)
  ...
  public BesuNode createCustomGenesisNode(final String name,
  ...
  public BesuNode
  createCustomGenesisNode(final String name, final String genesisPath,
                          final boolean canBeBootnode, final boolean mining)
      throws IOException {
  ...
  public BesuNode createCliqueNodeWithValidators(final String name,
        ...
        new BesuNodeConfigurationBuilder()
            ...
            .genesisConfigProvider(nodes
                                   -> node.createGenesisConfigForValidators(
                                       asList(validators), nodes,
                                       genesis::createCliqueGenesisConfig))
            .build());
  }

  public BesuNode createIbft2NodeWithValidators(final String name,
                                                final String... validators)
      throws IOException {
    ...
    return create(
        new BesuNodeConfigurationBuilder()
            ...
            .genesisConfigProvider(nodes
                                   -> node.createGenesisConfigForValidators(
                                       asList(validators), nodes,
                                       genesis::createIbft2GenesisConfig))
            .build());
  }

  public BesuNode createNodeWithStaticNodes(final String name,
                                            final List<Node> staticNodes)
      throws IOException {

    final List<String> staticNodesUrls = staticNodes.stream()
