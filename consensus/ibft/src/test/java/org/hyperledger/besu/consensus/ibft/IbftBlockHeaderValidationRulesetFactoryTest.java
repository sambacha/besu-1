...
public class IbftBlockHeaderValidationRulesetFactoryTest {
  ...
  private final ProtocolContext
  protocolContext(final Collection<Address> validators) {
    return new ProtocolContext(null, null,
  ...
  public void ibftValidateHeaderPasses() {
    ...
    final Address proposerAddress =
        Util.publicKeyToAddress(proposerNodeKey.getPublicKey());

    final List<Address> validators = singletonList(proposerAddress);

    final BlockHeader parentHeader =
        getPresetHeaderBuilder(1, proposerNodeKey, validators, null)
            .buildHeader();
  ...
  public void ibftValidateHeaderFailsOnExtraData() {
    ...
    final BlockHeader parentHeader =
        getPresetHeaderBuilder(1, proposerNodeKey, validators, null)
            .buildHeader();
    final BlockHeader blockHeader =
        getPresetHeaderBuilder(2, proposerNodeKey, emptyList(), parentHeader)
            .buildHeader();
  ...
  public void ibftValidateHeaderFailsOnAncestor() {
    ...
    final BlockHeader parentHeader =
        getPresetHeaderBuilder(1, proposerNodeKey, validators, null)
            .buildHeader();
    final BlockHeader blockHeader =
        getPresetHeaderBuilder(2, proposerNodeKey, validators, null)
            .buildHeader();
  ...
  private BlockHeaderTestFixture
  getPresetHeaderBuilder(final long number, final NodeKey proposerNodeKey,
    ...
    final IbftExtraData ibftExtraData = IbftExtraDataFixture.createExtraData(
        ...
        singletonList(proposerNodeKey), 0xDEADBEEF);
