...
// This class is responsible for creating a block without committer seals
// (basically it was just too hard to coordinate with the state machine).
public class IbftBlockCreator extends AbstractBlockCreator {
  ...
  public IbftBlockCreator(final Address localAddress,
    ...
    super(localAddress, extraDataCalculator, pendingTransactions,
          protocolContext, protocolSchedule, gasLimitCalculator,
          minTransactionGasPrice, localAddress, minBlockOccupancyRatio,
          parentHeader);
  }
