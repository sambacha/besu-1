...
/**
 * Ensures the Validators listed in the block header match that tracked in
 * memory (which was in-turn created by tracking votes included on the block
 * chain).
 */
public class IbftValidatorsValidationRule
  ...
  public boolean validate(final BlockHeader header, final BlockHeader parent,
    ...
    try {
      ...
      if (!Iterables.elementsEqual(ibftExtraData.getValidators(),
                                   storedValidators)) {
        LOGGER.trace("Incorrect validators. Expected {} but got {}.",
