...
public class CliqueProtocolScheduleTest {
  ...
  public void protocolSpecsAreCreatedAtBlockDefinedInJson() {
    ...
    final GenesisConfigOptions config =
        GenesisConfigFile.fromConfig(jsonInput).getConfigOptions();
    ...
    final ProtocolSpec tangerineWhistleSpec =
        protocolSchedule.getByBlockNumber(2);
    final ProtocolSpec spuriousDragonSpec =
        protocolSchedule.getByBlockNumber(3);
    final ProtocolSpec byzantiumSpec =
        protocolSchedule.getByBlockNumber(1035301);
  ...
  public void parametersAlignWithMainnetWithAdjustments() {
    final ProtocolSpec homestead =
        CliqueProtocolSchedule
            .create(GenesisConfigFile.DEFAULT.getConfigOptions(), NODE_KEY,
                    false)
            .getByBlockNumber(0);
    ...
    assertThat(homestead.getDifficultyCalculator())
