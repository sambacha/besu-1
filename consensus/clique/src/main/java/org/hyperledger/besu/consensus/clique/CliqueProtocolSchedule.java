...
public class CliqueProtocolSchedule {
  ...
  public static ProtocolSchedule
  create(final GenesisConfigOptions config, final NodeKey nodeKey,
    ...
    final EpochManager epochManager =
        new EpochManager(cliqueConfig.getEpochLength());
  ...
  public static ProtocolSchedule create(final GenesisConfigOptions config,
                                        ...
                                        final boolean isRevertReasonEnabled) {
    return create(config, nodeKey, PrivacyParameters.DEFAULT,
                  isRevertReasonEnabled);
  }

  private static ProtocolSpecBuilder applyCliqueSpecificModifications(
      final EpochManager epochManager, final long secondsBetweenBlocks,
      final Address localNodeAddress, final ProtocolSpecBuilder specBuilder) {
    return specBuilder
